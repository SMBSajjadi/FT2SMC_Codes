...
%% Genetic Optimization (Optimal)

% opt = optimoptions("ga","MaxGenerations",50);
% nParams = 12;
% LB = 1e-3*ones(nParams,1);
% [kOptimal,Feval,exitFlag] = ga(@(K)MainGaFunctionToFindOptimalGains(K),...
%                                                      nParams,[],[],[],[],LB,[],[]);
